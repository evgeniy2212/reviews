<header>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 d-flex flex-column justify-content-between" id="sitename">
                <span>
...
{{--                            <a href="{{ LaravelLocalization::localizeUrl('/register') }}">Sign Up</a>--}}
            ...
            <div class="col-md-3">
                <img  class="pull-right" src="{{ asset('images/advertising.jpg') }}" height="200px" width="300px"/>
            </div>
        </div>
    </div>
    <div class="container">
